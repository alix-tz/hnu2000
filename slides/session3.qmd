...
## Annotation sémantique et annotation stylistique {.scrollable}
...
Il existe des variantes de Markdown (GitHub Flavored Markdown, CommonMark, etc.) qui ajoutent des fonctionnalités supplémentaires.
