...
## <span style="color:black; background-color:white;">Prenons le temps de regarder le document et la structure des données</span> {background-iframe="../img/session1_pdf_view.png"}

<!--![](../img/session1_pdf_view.png "Capture d'écran d'un double page visualisée dans le visualiseur d'Internet Archive")-->
...
## <span style="color:black; background-color:white;">`Month .+?\d{4}`</code></span> {background-iframe="../img/session1_regex_1.png"}

<!--![](../img/session1_regex_1.png)-->
...
expliquer certains caractères spéciaux: 
...
expliquer : on rajouter une tabulation lorsqu'on ne connaît pas l'Etat dans lequel se situe la ville.
faire un collage spécial dans calc pour montrer la différence avant/après
...
- il reste donc des corresponds à faire à la main
